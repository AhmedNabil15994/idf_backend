...
<script src="{{asset('admin/js/plugins/bootstrap-fileinput/js/fileinput.min.js')}}"></script>
<script src="{{asset('admin/js/plugins/bootstrap-fileinput/js/fileinput_locale_ar.js')}}"></script>
