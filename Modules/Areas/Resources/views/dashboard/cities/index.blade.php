...
@section('title', __('areas::dashboard.cities.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('areas::dashboard.cities.routes.index')}}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('areas::dashboard.cities.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('areas::dashboard.cities.datatable.title')}}</th>
                                    <th>{{__('areas::dashboard.cities.datatable.governorate')}}</th>
                                    <th>{{__('areas::dashboard.cities.datatable.status')}}</th>
                                    <th>{{__('areas::dashboard.cities.datatable.created_at')}}</th>
                                    <th>{{__('areas::dashboard.cities.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
      ...
      $('#dataTable').DataTable({
          ...
          columns: [
            {data: 'id' 		 	    , className: 'dt-center'},
  			...
  			{data: 'governorate_id' 			    , className: 'dt-center'},
          ...
          columnDefs: [
      			...
      			},
            {
              targets: -1,
              width: '13%',
              title: '{{__('areas::dashboard.cities.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
