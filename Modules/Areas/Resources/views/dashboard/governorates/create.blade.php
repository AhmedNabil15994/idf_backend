...
@section('title', __('areas::dashboard.governorates.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('areas::dashboard.governorates.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
                {!! Form::model($governorate,[
                               'url'=> route('dashboard.governorates.store'),
                               'id'=>'form',
                               'role'=>'form',
                               'method'=>'POST',
