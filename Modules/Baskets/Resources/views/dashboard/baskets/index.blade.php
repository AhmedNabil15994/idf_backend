...
@section('title', __('baskets::dashboard.baskets.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('baskets::dashboard.baskets.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.baskets.create')) }}" class="btn sbold green">
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                {{__('baskets::dashboard.baskets.routes.index')}}
                            </span>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.image')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.title')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.description')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.price')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.quantity')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.status')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.created_at')}}</th>
                                    <th>{{__('baskets::dashboard.baskets.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.baskets.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.baskets.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('baskets::dashboard.baskets.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.baskets.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.baskets.destroy", ":id") }}';
