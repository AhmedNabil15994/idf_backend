...
@section('title', __('catalog::dashboard.charters.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('catalog::dashboard.charters.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.charters.create')) }}"
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                {{__('catalog::dashboard.charters.routes.index')}}
                            </span>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.title')}}</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.btn_title')}}</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.description')}}</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.status')}}</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.created_at')}}</th>
                                    <th>{{__('catalog::dashboard.charters.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.charters.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.charters.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'btn_title', className: 'dt-center'},
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('catalog::dashboard.charters.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.charters.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.charters.destroy", ":id") }}';
