...
@section('title', __('catalog::dashboard.nationalities.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('catalog::dashboard.nationalities.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
                {!! Form::model($nationality,[
                               'url'=> route('dashboard.nationalities.store'),
                               'id'=>'form',
                               'role'=>'form',
                               'method'=>'POST',
