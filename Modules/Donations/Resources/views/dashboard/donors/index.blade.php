...
@section('title', __('donations::dashboard.donors.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('donations::dashboard.donors.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        @can('add_donors')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.donors.create')) }}"
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                {{__('donations::dashboard.donors.routes.index')}}
                            </span>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('donations::dashboard.donors.datatable.name')}}</th>
                                    <th>{{__('donations::dashboard.donors.datatable.email')}}</th>
                                    <th>{{__('donations::dashboard.donors.datatable.phone')}}</th>
                                    <th>{{__('donations::dashboard.donors.datatable.status')}}</th>
                                    <th>{{__('donations::dashboard.donors.datatable.created_at')}}</th>
                                    <th>{{__('donations::dashboard.donors.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.donors.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.donors.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'id', responsivePriority: 1, className: 'dt-center'},
                    ],
                    columnDefs: [
                        {
                            targets: 0,
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('donations::dashboard.donors.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.donors.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.donors.destroy", ":id") }}';
