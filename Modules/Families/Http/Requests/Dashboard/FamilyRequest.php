...
namespace Modules\Families\Http\Requests\Dashboard;
...
class FamilyRequest extends FormRequest
{
        ...
        switch ($this->getMethod()) {
            ...
            case 'POST':
                ...
                return [
                    ...
                    'charity_id' => 'nullable|:charities,id',
    ...
    public function messages()
    {
        $v = [
            ...
            'region.required' => __('families::dashboard.families.validation.region_id.required'),
            'region.exists' => __('families::dashboard.families.validation.region_id.required'),
            ...
            'city_id.required' => __('families::dashboard.families.validation.city.required'),
            'city_id.exists' => __('families::dashboard.families.validation.city.required'),
