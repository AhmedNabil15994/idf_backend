                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description[{{$code}}]" id="description.{{$code}}" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="description.{{$code}}"></textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('page::dashboard.pages.form.long_description')}}
                                                </label>
                                                <div class="col-md-9">
                                                    <textarea name="long_description[{{$code}}]" id="long_description.{{$code}}" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="long_description.{{$code}}"></textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
