                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{ $page->translate($code)->title }}" {{ (is_rtl($code) == 'rtl') ? 'dir=rtl' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description[{{$code}}]" id="description.{{$code}}" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="description.{{$code}}">{{ $page->translate($code)->description }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('page::dashboard.pages.form.long_description')}} - {{ $code }}
                                                </label>
                                                <div class="col-md-9">
                                                    <textarea name="long_description[{{$code}}]" id="long_description.{{$code}}" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="long_description.{{$code}}">{{ $page->translate($code)->long_description }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
