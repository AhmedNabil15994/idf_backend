<div class="tab-pane fade" id="other">
    ...
    <div class="col-md-10">
        ...
        <div class="form-group">
            <label class="col-md-2">
                {{ __('setting::dashboard.settings.form.charity') }}
            </label>
            <div class="col-md-9">
                <select name="other[charity]" id="single" class="form-control select2">
                    <option value=""></option>
                    @foreach ($pages as $page)

                    <option value="{{ $page['id'] }}" {{( setting('other','charity') == $page->id) ? ' selected="" ' : ''}}>
                        {{ $page->translate(locale())->title }}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            <label class="col-md-2">
                {{ __('setting::dashboard.settings.form.volunteer') }}
            </label>
            <div class="col-md-9">
                <select name="other[volunteer]" id="single" class="form-control select2">
                    <option value=""></option>
                    @foreach ($pages as $page)

                    <option value="{{ $page['id'] }}" {{( setting('other','volunteer') == $page->id) ? ' selected="" ' : ''}}>
                        {{ $page->translate(locale())->title }}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            <label class="col-md-2">
                {{ __('setting::dashboard.settings.form.charters') }}
            </label>
            <div class="col-md-9">
                <select name="other[charters]" id="single" class="form-control select2">
                    <option value=""></option>
                    @foreach ($pages as $page)
                    <option value="{{ $page['id'] }}" {{(setting('other','charters') == $page->id) ? ' selected="" ' : ''}}>
                        {{ $page->translate(locale())->title }}
                    </option>
                    @endforeach
                </select>
